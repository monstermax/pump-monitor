...
import { ParsedTransactionWithMeta, Message, MessageV0, PublicKey, SendTransactionError, VersionedTransactionResponse } from "@solana/web3.js";
...
export function versionedMessageFromResponse(version: number | 'legacy', message: Message) {
