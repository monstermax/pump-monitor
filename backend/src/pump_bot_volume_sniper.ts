...
import { sendSellTransaction } from "./lib/pumpfun/manual_tx/pumpfun_sell";
import { sendBuyTransaction } from "./lib/pumpfun/manual_tx/pumpfun_buy";
...
const slippage = 15;
const portalPriorityFee = 0.00001;

const minSolInWallet = 0.08;
...
async function buyAndSell(tokenAddress: string) {
    ...
    const buyResult: TransactionResult = useJito
        ...
        : await sendBuyTransaction(connection, botWallet, tokenAddress, solAmount, slippage, portalPriorityFee);
    ...
    const sellResult: TransactionResult = useJito
        ...
        : await sendSellTransaction(connection, botWallet, tokenAddress, tokenAmount, slippage, portalPriorityFee);
